...
import moviepy.audio.io.AudioFileClip as moviepy
import re
import os
...
def downloadExecute():
    ...
    try:
        ...
        messagebox.showerror(title="Link Inválido!", message="O link inserido é inválido! Verifique se o link foi copiado corretamente e tente o download novamente.")
        exit()
            ...
            if (vq == 3):
                ...
                for file in os.listdir(path):
                    if re.search('mp4', file):
                        ...
                        newFile.write_audiofile(mp3, logger=None)
...
#Cria uma função para a execução de download em uma Thread para a execução de download
